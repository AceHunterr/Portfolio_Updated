window.onload = ()=>{
    gsap.set("#scrollDist", {
        ...
        onComplete: ()=>{
            ...
            gsap.timeline({
                ...
                pointerEvents: "none",
                stagger: -0.3
            }, 1.27).add("end").fromTo("#txt2", {
                scale: 0.1,
                transformOrigin: "50%"
            }, {
                scale: 0.6,
                ease: "power3"
            }, "end-=0.2").from("#txt2 path", {
                duration: 0.4,
                drawSVG: 0,
                ease: "sine.inOut",
                stagger: 0.15
    ...
    function initImg(i, t) {
        ...
        t.onmouseover = ()=>gsap.to("#cursorCircle", {
                duration: 0.2,
                attr: {
                    r: 30,
                    "stroke-width": 4
        ...
        t.onmouseup = ()=>gsap.to(t, {
                z: 0,
                ease: "power1.inOut"
            });
        t.onmouseout = ()=>gsap.to("#cursorCircle", {
                duration: 0.2,
                attr: {
                    r: 11,
                    "stroke-width": 3
...
//# sourceMappingURL=gallery.dcecda5c.js.map
